...
import static br.com.apptransescolar.Activies.PerfilActivity.dialogP;
import static br.com.apptransescolar.Activies.TiosActivity.dialogG;
    ...
    public void onReceive(Context context, Intent intent)
    {
        try
        {
            if (isOnline(context) || isNetworkConnected(context)) {
                dialogP(true, context);
                Log.e("Conexão", "Online Connect Intenet ");
            } else {
                dialogP(false, context);
